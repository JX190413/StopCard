			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="logname" placeholder="请输入操作人姓名" id="demoReload" autocomplete="off" class="layui-input">
					</div>
				</div>
...
<script>
	...
	layui.use('table', function(){
		...
		dicTabel =table.render({
			...
			,limit:5
			,limits:[5]
			,url:'/StopCard/Logmanagement.action'
			// ,method:'post'
			,page: true
			,id:'testReload'
			,cols: [[ //标题栏
				{field: 'logid', title: '日志序号', sort: true ,align:'center'}
				,{field: 'logname', title: '操作人名',align:'center' }
				,{field: 'information', title: '日志事件',align:'center'}
				...
				layer.open({
					...
					,yes: function(index, layero){
                       ...
                       alert("月缴产品名-----"+combotime);
						...
						$.ajax({
							type: "POST",//提交的方式
							url: "/demo5/addMonthlyPayment.action",//提交的地址
							data: ob,//提交的数据
			...
			if(obj.event === 'detail'){
				layer.open({
					...
					,yes: function(index, layero){
						...
						$.ajax({
							type: "POST",//提交的方式
							url: "/demo5/revisedevic.action",//提交的地址
							data: ob,//提交的数据
							dataType: "json",//希望返回的数据类型
							async: true,//异步操作
							success: function (msg) {//成功的方法  msg为返回数据
				...
				layer.confirm('真的删除行么', function(index){
					...
					$.ajax({
						type: "POST",//提交的方式
						url: "/demo5/deMonthlyPayment.action",//提交的地址
						data: ob,//提交的数据
						dataType: "json",//希望返回的数据类型
						async: true,//异步操作
						success: function (msg) {//成功的方法  msg为返回数据
