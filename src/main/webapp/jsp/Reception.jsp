						...
						<div class="cssBox">
							<div class="borderRadius">
								<div class="scene">
									...
									preserveAspectRatio="xMinYMin meet"
									>
									<text x="9" y="21" font-family="Monaco" font-size="2px" style="letter-spacing:0.6" fill="grey"><a style=" color: white; font-size: 5px;" href="index.html">车辆出场</a>
										<animate
												attributeName="opacity"
												values="0;1;0" dur="1.8s"
												repeatCount="indefinite"/>
						...
						<div class="cssBox">
							<div class="borderRadius">
								<div class="scene">
									...
									preserveAspectRatio="xMinYMin meet"
									>
									<text x="9" y="21" font-family="Monaco" font-size="2px" style="letter-spacing:0.6" fill="grey"><a style=" color: white; font-size: 5px;" href="index.html">业务办理</a>
										<animate
												attributeName="opacity"
												values="0;1;0" dur="1.8s"
												repeatCount="indefinite"/>
