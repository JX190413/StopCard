...
<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="inoutid" lay-verify="email" id="inoutid" autocomplete="off" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="carnum" lay-verify="email" id="carnum" autocomplete="off" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="money" lay-verify="email" id="money" autocomplete="off" class="layui-input">
		</div>
	</div>
	<button class="layui-btn layuiadmin-btn-useradmin" data-type="submit" style="display:block;margin:0 auto">缴费</button>
